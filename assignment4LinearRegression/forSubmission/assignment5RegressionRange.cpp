...
// find the linear regression parameters with a range constraint of 1 to max_theta0
void findLinearRegressionParameters(int range) {
    ...
    cout << "suggested model: theta0 = " << suggestedTheta0 << ", theta1 = " << suggestedTheta1 << endl;
}
